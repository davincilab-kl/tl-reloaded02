...
const MODAL_LOAD_PROJECT = 'loadProjectModal';
const MODAL_PUBLISH_PROJECT = 'publishProjectModal';
...
const initialState = {
    ...
    [MODAL_LOAD_PROJECT]: false,
    [MODAL_PUBLISH_PROJECT]: false
};
...
const openLoadProjectModal = function () {
    return openModal(MODAL_LOAD_PROJECT);
};
const closeLoadProjectModal = function () {
    return closeModal(MODAL_LOAD_PROJECT);
};
const openPublishProjectModal = function () {
    return openModal(MODAL_PUBLISH_PROJECT);
};
const closePublishProjectModal = function () {
    return closeModal(MODAL_PUBLISH_PROJECT);
};
export {
    reducer as default,
