    ...
    try {
        ...
        if (data.threads && data.threads.length > 0) {
            threadsList.innerHTML = data.threads.map(thread => {
                ...
                // Verwende den Namen des ursprünglichen Users, mit dem der Admin korrespondiert
                const displayName = thread.thread_user_name || thread.last_message_sender_name || 'Unbekannt';
                ...
                <div class="thread-message ${msg.is_admin ? 'admin-message' : 'user-message'}">
                    <div class="thread-message-header">
                        <div class="thread-message-author">
                            ...
                            <span class="thread-sender-name">${msg.sender_name || 'TalentsLounge-Team'}</span>
                        </div>
