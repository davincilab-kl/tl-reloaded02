...
export default function StudentLayout({
    ...
    const navItems = [
        ...
        { label: 'Meine Projekte', href: '/dashboard/student/projects', icon: Folder },
        { label: 'Leaderboards', href: '/dashboard/student/leaderboards', icon: Trophy },
        { label: 'Kurse', href: '/dashboard/student/courses', icon: BookOpen },
    ];
            ...
            <div className="min-h-screen bg-[#F8F9FA] flex flex-col md:flex-row">
                ...
                >
                    ...
                    <div className="p-4 border-t border-gray-200">
                        <Link href="/dashboard/student/profile" className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-xl transition-colors mb-2">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="truncate text-xs text-gray-500">Schüler:in</p>
                            </div>
                        </Link>
